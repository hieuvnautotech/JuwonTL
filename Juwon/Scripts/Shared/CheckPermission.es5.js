...
function CheckPermissions() {
    $('button').each(function () {
        ...
        var n = classArr.includes('ui-dialog-titlebar-close');
        var m = classArr.includes('rounded-circle');
        var iSearch = classArr.includes('iBtnSearch');
        if (!permissions) {
            $(this).remove();
        } else {
            var flag = classArr.some(function (x) {
...
function DateTimeToString(e) {
    ...
    var date = String(e.getDate()).padStart(2, '0');
    var month = String(e.getMonth() + 1).padStart(2, '0'); //January is 0!
    var year = e.getFullYear();

    var hour = String(e.getHours()).padStart(2, '0');
    var minute = String(e.getMinutes()).padStart(2, '0');
    var second = String(e.getSeconds()).padStart(2, '0');
...
function DateToStringLotCode() {
    ...
    var str = '' + y + month + date + hour + minute + second;
    return str;
}
