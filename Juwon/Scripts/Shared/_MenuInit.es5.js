...
$(document).ready(function () {
    function t(t) {
        var rt = undefined,
            ...
            wi;
        try {
            for (s = t[Symbol.iterator](); !(ut = (ni = s.next()).done); ut = !0) if ((u = ni.value, u.MenuLevel == 2)) {
                rt = u.MenuOrderly;
                break;
            }
        } catch (ft) {
        ...
        switch (o) {
            case "MMS":
                var ot = !0,
                    ...
                    ii = undefined;
                try {
                    for (h = t[Symbol.iterator](); !(ot = (ri = h.next()).done); ot = !0) if ((u = ri.value, u.FullName == "MMS")) {
                        f(u.MenuOrderly);
                        e(u.MenuOrderly);
                        break;
                    }
            ...
            case "WMS":
                if ((fi = (function () {
                    ...
                    ht = undefined;
                    try {
                        for (y = t[Symbol.iterator](); !(v = (ui = y.next()).done); v = !0) if ((n = ui.value, n.FullName == "WMS")) {
                            f(n.MenuOrderly);
                            e(n.MenuOrderly);
                            break;
                        }
            ...
            case "QMS":
                if ((oi = (function () {
                    ...
                    lt = undefined;
                    try {
                        for (w = t[Symbol.iterator](); !(p = (ei = w.next()).done); p = !0) if ((n = ei.value, n.FullName == "QMS")) {
                            f(n.MenuOrderly);
                            e(n.MenuOrderly);
                            break;
                        }
            ...
            case "Monitor":
                var at = !0,
                    ...
                    hi = undefined;
                try {
                    for (b = t[Symbol.iterator](); !(at = (ci = b.next()).done); at = !0) if ((u = ci.value, u.FullName == "Monitor")) {
                        f(u.MenuOrderly);
                        e(u.MenuOrderly);
                        break;
                    }
            ...
            case "Standard":
                if ((ai = (function () {
                    ...
                    yt = undefined;
                    try {
                        for (d = t[Symbol.iterator](); !(k = (li = d.next()).done); k = !0) if ((n = li.value, n.FullName == "Standard")) {
                            f(n.MenuOrderly);
                            e(n.MenuOrderly);
                            break;
                        }
            ...
            case "Cài đặt":
                if ((yi = (function () {
                    ...
                    wt = undefined;
                    try {
                        for (nt = t[Symbol.iterator](); !(g = (vi = nt.next()).done); g = !0) if ((n = vi.value, n.FullName == "Standard")) {
                            f(n.MenuOrderly);
                            e(n.MenuOrderly);
                            break;
                        }
            ...
            case "표준":
                if ((wi = (function () {
                    ...
                    kt = undefined;
                    try {
                        for (it = t[Symbol.iterator](); !(tt = (pi = it.next()).done); tt = !0) if ((n = pi.value, n.FullName == "Standard")) {
                            f(n.MenuOrderly);
                            e(n.MenuOrderly);
                            break;
                        }
